...
public class CompleteTransectionActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_complete_order_amount);
        inItView();
        progressBar.setVisibility(View.VISIBLE);
        appName.setVisibility(View.INVISIBLE);
        back.setVisibility(View.VISIBLE);
        title.setVisibility(View.VISIBLE);
        title.setText("সফল অর্ডার");
        ...
        myOrderCall.enqueue(new Callback<MyOrder>() {
            ...
            public void onResponse(Call<MyOrder> call, Response<MyOrder> response) {
                if(response.code() == 200){
                    ...
                    myOrderAdapter = new MyOrderAdapter(CompleteTransectionActivity.this, completeOrderArrayList);
                    completeOrderRevView.setLayoutManager(new LinearLayoutManager(CompleteTransectionActivity.this));
            ...
            progressBar.setVisibility(View.GONE);
                Toast.makeText(CompleteTransectionActivity.this, t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void inItView() {
        ...
        completeOrderRevView = findViewById(R.id.completeOrderAmountRevView);
