...
public class CompleteOrderAmountActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void getCompleteOrderAmountList() {
        ...
        myOrderCall.enqueue(new Callback<MyOrder>() {
            ...
            progressBar.setVisibility(View.GONE);
                Toast.makeText(CompleteOrderAmountActivity.this, t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
